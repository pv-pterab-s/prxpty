...
if process.env.DBG is 'stdin' or process.env.DBG is 'all'
...
if process.env.DBG is 'stdout' or process.env.DBG is 'all'
  standard-stdout-write = process.stdout.write
  process.stdout.write = (d) ->
    out-line = (log.msg2log d.toString!) + '\n'
    standard-stdout-write.call process.stdout, out-line
